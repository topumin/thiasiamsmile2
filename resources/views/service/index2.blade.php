...
@section('title')
    Siam Smile Thai Massage - Relaxation Massage
@endsection
@section('css')
<!-- Font files -->
            ...
            <div class="content-box container">
                <div class="inside-wrapper container">
                    ...
                    <div class="row">
                        <!-- image -->
                        <div class="col-md-6">
                            <img class="img-responsive img-paragraph center-block"
                                src="{{ asset('img/services/service4.jpg') }}" alt="">
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="bg-color1 col-md-12">
                    <div class="inside-wrapper container">
                        <h3 class="text-center text-light no-margin-top">{{ trans('site.sub_service2') }}</h3>
                        <!-- Team carousel -->
